...
namespace GoogleDesktopWidget.Interop;
...
public static class Win32Interop
{
    ...
    public static void EnableAcrylic(IntPtr hwnd, uint gradientColor = 0x991E1F22)
    {
        // Try Windows 11 22H2+ modern backdrop first (DWMSBT_TRANSIENTWINDOW / Acrylic = 3)
        int backdropType = 3;
        int hr = DwmSetWindowAttribute(hwnd, DWMWA_SYSTEMBACKDROP_TYPE, ref backdropType, sizeof(int));
        
        // Fallback or accent policy for consistent Acrylic frosted look
